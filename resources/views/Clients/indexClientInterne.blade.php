...
<center>    
    <div class="bg-light p-5 rounded mt-3">
        <h1>Bienvenu Chez <b>{{ $boutique[0]->nom }}</b></h1>
        <p class="lead">Votre Boutique de vente de produits Alimentaires <b>Thiagry, Galakh, Sow etc.</b>
        </p>
        
        <a class="btn btn-lg btn-primary" href="#" role="button">Voire Plus de detaille Sur notre Boutique &raquo;</a>
    </div>
</center>
<hr>
<div class="row">
    ...
    <div class="col-md-3 mt-1">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{route('detailleProduitClient',$produit->id)}}" class="btn btn-info mt-2">Détails</a>
