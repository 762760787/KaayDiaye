  ...
  <body>
    <div class="sidebar">
      <div class="logo-details">
        ...
        <span class="logo_name" style="margin: 0px; font-size:22px;"><b>KAAYE DJAAYE</b></span>
      </div>
      <ul class="nav-links">
        <li>
        ...
        <li>
          <a href="{{route('listeProduitStock')}}">
            <i class="bx bx-coin-stack"></i>
